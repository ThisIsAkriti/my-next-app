...
const Instructors = () => {
    return(
        <div className="relative md:h-[40rem] h-[10rem]overflow-hidden flex items center justify-center">
            <WavyBackground className="flex flex-col w-full max-w-7xl mx-auto items-center justify-center h-full">
                ...
                <p className="text-base md:text-lg text-white text-center mb-4 mx-4">Discover the talented professionals who will guide your fitness journey incredible</p>
